...
// GraphQL Mutation
var CHANGE_STATUS_MUTATION = (0, _graphqlTag.default)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  mutation ChangeStatus($_id: ID!, $seatStatus: String!) {\n    changeStatus(_id: $_id, seatStatus: $seatStatus)\n  }\n"])));
var View = function View(_ref) {
  var traveller = _ref.traveller,
  ...
  var _useState3 = (0, _react.useState)(false),
    ...
    setIsModalVisible = _useState4[1]; // 控制模态框显示状态
  var _useState5 = (0, _react.useState)(null),
    _useState6 = _slicedToArray(_useState5, 2),
    selectedTraveller = _useState6[0],
    setSelectedTraveller = _useState6[1]; // 选中的旅客
  var _useState7 = (0, _react.useState)([]),
    _useState8 = _slicedToArray(_useState7, 2),
    unreservedTravellers = _useState8[0],
    setUnreservedTravellers = _useState8[1]; // 未预订的旅客信息
  var _useState9 = (0, _react.useState)(null),
    _useState10 = _slicedToArray(_useState9, 2),
    currentSeat = _useState10[0],
    setCurrentSeat = _useState10[1]; // 当前选择的座位

  var _useMutation = (0, _client.useMutation)(CHANGE_STATUS_MUTATION),
    _useMutation2 = _slicedToArray(_useMutation, 1),
    changeStatus = _useMutation2[0]; // 使用 GraphQL Mutation
  ...
  var columns = [{
    ...
    key: 'status',
    render: function render(text) {
      return /*#__PURE__*/_react.default.createElement(_antd.Space, null, text === 'Reserved' ? /*#__PURE__*/_react.default.createElement(_antd.Badge, {
        status: "success",
        text: text
  ...
  // 打开模态框并获取未预订的旅客信息
  var handleOpenModal = function handleOpenModal(record) {
    setCurrentSeat(record); // 保存当前座位信息
    var unreserved = traveller.filter(function (t) {
      return t.seatStatus === 'Not Reserved';
    });
    ...
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 4:
            // 更新本地状态
            updatedTravellers = traveller.map(function (item) {
              return item._id === selectedTraveller._id ? _objectSpread(_objectSpread({}, item), {}, {
                seatStatus: 'Reserved'
              }) : item;
            });
          ...
          case 8:
            ...
            console.error('Failed to update seat status:', _context.t0);
          case 11:
  ...
  // 选择旅客时触发
  var onTravellerChange = function onTravellerChange(e) {
    setSelectedTraveller(e.target.value); // 保存选中的旅客信息
  };
  (0, _react.useEffect)(function () {
    if (Array.isArray(traveller)) {
      var newData = traveller.map(function (item) {
        return {
          key: item.key,
  ...
  }, unreservedTravellers.map(function (traveller) {
